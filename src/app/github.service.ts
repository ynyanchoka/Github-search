...
export class UserServiceService {
  ...
  repoRequest (username:string): Observable<Array<Repository>> {
    return this.http.get<Array<Repository>>(`https://api.github.com/users/${username}/repos?client_id=${environment.clientId}&client_secret=${environment.apiKey}`);
  }

  repoGet (repoName:string): Observable<Array<Repository>> {
    return this.http.get<Array<Repository>>(`https://api.github.com/users/${this.username}/repos?client_id=${environment.clientId}&client_secret=${environment.apiKey}`);
  }
